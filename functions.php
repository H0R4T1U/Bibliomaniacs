...
function simple_boostrap_theme_support() {
    ...
    add_image_size( 'simple_boostrap_featured', 1140, 1140 * (9 / 21), false);
...
add_action( 'wp_enqueue_scripts',function(){
    wp_enqueue_style('slick-style', get_template_directory_uri() . '/inc/slick/slick.css', array(), '1');
    wp_enqueue_style('slick-style-theme', get_template_directory_uri() . '/inc/slick/slick-theme.css',array(),'1');
    wp_enqueue_script('slick-script', get_template_directory_uri() . '/inc/slick/slick.min.js', array("jquery"), '1', true);
    wp_enqueue_script('test-script',get_template_directory_uri().'/js/Horatiu.js',array("jquery"),"1");// il  scot de aici cand hotaram cum facem cu scripts si styles
});
